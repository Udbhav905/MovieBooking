...
import MoviesLogo from "../Animations/MoviesLogo.jsx";
  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      <Link to="/" className="max-md:flex-1">
        ...
        <MoviesLogo className="w-36 h-auto border-0" />
      </Link>
      <div
      ...
      <div className="flex items-center gap-8">
        ...
        {!user ? (
          <button
            onClick={openSignIn}
            className="px-3 py-3 sm:px-3 sm:py-2 bg-primary hover:bg-primary-dull transition rounded-full 
